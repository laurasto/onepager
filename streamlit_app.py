...
st.set_page_config(page_title="OnePager", page_icon=":lemon:", layout="wide", initial_sidebar_state=None, menu_items=None)
with st.sidebar:
...
with tab2:
    ...
    with col2:
        ...
        with col_left:
            st.image("https://raw.githubusercontent.com/laurasto/onepager/master/images/Flag_of_the_Netherlands.svg.webp")
            st.image("https://raw.githubusercontent.com/laurasto/onepager/master/images/Flag_of_the_United_Kingdom_(1-2).svg.webp")
            st.image("https://raw.githubusercontent.com/laurasto/onepager/master/images/Flag_of_Finland.svg.webp")
            st.image("https://raw.githubusercontent.com/laurasto/onepager/master/images/Flag_of_Japan.svg.webp")
        with col_right:
            st.write("Fluent")
            st.write("Fluent")
